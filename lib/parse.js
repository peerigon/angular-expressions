...
AST.prototype = {
	...
	unary: function () {
		...
		if ((token = this.expect("+", "-", "!"))) {
			this.guardSyntax("UnaryExpression");
			return {
	...
	filter: function (baseExpression) {
		...
		this.guardSyntax("FilterExpression");
		return result;
	},
...
ASTCompiler.prototype = {
	compile: function (expression) {
		...
		var wrappedFn = new Function(
			...
			"hasOwn",
			fnString
		)(this.$filter, $call, getStringValue, ifDefined, plusFn, hasOwn);
